    ...
    <div className={styles.container}>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.headertext}>
          ...
          <div>
            <p><a href='/resume.pdf' className={styles.link} target='_blank'>Check out my resume here!</a></p>
          </div>
        </div>
        <div className={styles.info}>
          <p>Phone: 480-452-5737</p>
          <p>Email: tatebonham@gmail.com</p>
          <p>Github: <a className={styles.link} href='https://github.com/tatebonham' target='_blank'>github.com/tatebonham</a></p>
          <p>LinkedIn: <a className={styles.link} href='https://www.linkedin.com/in/tate-bonham/' target='_blank'>in/tatebonham</a></p>
      ...
      <div className={styles.skills}><h4>HTML | CSS | Javascript | React | Express | Node | Git | MongoDB | SQL | SASS/SCSS | Axios </h4></div>
        ...
        <div className={styles.ddtext}>
          <h2>Dungeon Diver</h2>
          <p><a href='https://tatebonham.github.io/Dungeon-Diver/' target='_blank' className={styles.link}>Github</a> | <a href='https://github.com/tatebonham/Dungeon-Diver' target='_blank' className={styles.link}>Live</a></p>
          <ul>
        ...
        <h2>DnDs"R"Us</h2>
        <p><a href='https://github.com/tatebonham/DnDs-R-Us' target='_blank' className={styles.link}>Github</a></p>
          <ul>
        ...
        <h2>Judgement Day</h2>
        <p><a href='https://judgement-day-tatebonham.koyeb.app/' target='_blank' className={styles.link}>Github</a> | <a href='https://judgement-day-tatebonham.koyeb.app/' target='_blank' className={styles.link}>Live</a></p>
          <ul>
        ...
        <div className={styles.gdtext}>
          <h2>Goal Digger</h2>
          <p><a href='https://github.com/tatebonham/goal-digger' target='_blank' className={styles.link}>Github</a> | <a href='https://helpful-dusk-923e50.netlify.app/' target='_blank' className={styles.link}>Live</a></p>
          <ul>
